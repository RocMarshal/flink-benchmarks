...
public class SkewableHigherMultiply extends RichMapFunction<Long, Long> {
    ...
    public SkewableHigherMultiply(int additionalCostMillisPerRecord, Integer... expectedSkewedSubTasksIndexes) {
        this.additionalCostMillisPerRecord = additionalCostMillisPerRecord;
        this.expectedSkewedSubTasksIndexes = new HashSet<>(Arrays.asList(expectedSkewedSubTasksIndexes));
    }
    ...
    public Long map(Long value) throws Exception {
        ...
        if (additionalCostMillisPerRecord <= 0) {
            ...
            if (expectedSkewedSubTasksIndexes.contains(getRuntimeContext().getTaskInfo().getIndexOfThisSubtask())) {
