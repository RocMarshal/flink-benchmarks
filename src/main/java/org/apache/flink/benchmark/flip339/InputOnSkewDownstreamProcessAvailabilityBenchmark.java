...
package org.apache.flink.benchmark.flip339;
...
@OperationsPerInvocation(value = InputOnSkewDownstreamProcessAvailabilityBenchmark.RECORDS_PER_INVOCATION)
public class InputOnSkewDownstreamProcessAvailabilityBenchmark extends BenchmarkBase {
    ...
    public static void main(String[] args) throws RunnerException {
        Options options =
                new OptionsBuilder()
                        ...
                        .include(".*" + InputOnSkewDownstreamProcessAvailabilityBenchmark.class.getCanonicalName() + ".*")
                        .build();
    ...
    @Benchmark
    public void mapRebalanceMapSink(InputBenchmarkFlinkEnvironmentContext context) throws Exception {
    ...
    private void configAdaptivePartitioner(StreamExecutionEnvironment env) {
        ...
        config.set(NettyShuffleEnvironmentOptions.ADAPTIVE_PARTITIONER_MAX_TRAVERSE_SIZE, adaptivePartitionerMaxTraverseSize);
